export function Gradient() {
    return (
        <>
            ...
            {/* gradient */}
            <div className="fixed top-1/2 left-1/2 w-screen aspect-square h-full -translate-x-1/2 -translate-y-1/2 pointer-events-none z-40 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0)_40%,rgba(255,255,255,0.8)_85%,rgba(255,255,255,1)_100%)]" />
            {/* noise */}
