        ...
        <>
            {theme === "light" ? (
                <>
                    ...
                    {/* gradient */}
                    <div className="z-10 fixed top-1/2 left-1/2 w-screen aspect-square h-full -translate-x-1/2 -translate-y-1/2 pointer-events-none backdrop-blur-xs [mask-image:radial-gradient(circle_at_center,rgba(0,0,0,0)_60%,rgba(0,0,0,0.2)_70%,rgba(0,0,0,.8)_97%)]"/>
