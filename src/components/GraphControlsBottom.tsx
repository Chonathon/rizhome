...
export function GraphControlsBottom() {
  ...
  return (
    <motion.div
      ...
      className={`w-sm flex flex-col gap-2 p-2 rounded-xl overflow-hidden   ${activePanel ? "bg-white border border-gray-200 shadow-md" : ""}`}
    >
